#determina se o inimigo está próximo do jogador e, em caso afirmativo, ataca; 
# caso contrário, ele se moverá em direção ao inimigo. Projetado para jogos feitos em turnos
import sys
